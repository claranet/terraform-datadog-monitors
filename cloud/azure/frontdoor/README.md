...
| <a name="input_frontdoor_total_latency_threshold_critical"></a> [frontdoor\_total\_latency\_threshold\_critical](#input\_frontdoor\_total\_latency\_threshold\_critical) | Maximum acceptable end to end total latency (ms) for Front Door | `number` | `100` | no |
| <a name="input_frontdoor_total_latency_threshold_warning"></a> [frontdoor\_total\_latency\_threshold\_warning](#input\_frontdoor\_total\_latency\_threshold\_warning) | Warning threshold for Front Door total lantency | `number` | `80` | no |
