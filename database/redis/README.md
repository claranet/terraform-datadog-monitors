...
|------|-------------|:----:|:-----:|:-----:|
| blocked_clients_extra_tags | Extra tags for Redis Blocked clients monitor | string | `` | no |
...
| evictedkeys_change_extra_tags | Extra tags for Redis evicted keys monitor | string | `` | no |
...
| expirations_rate_extra_tags | Extra tags for Redis keys expirations monitor | string | `` | no |
...
| hitrate_extra_tags | Extra tags for Redis hitrate monitor | string | `` | no |
...
| keyspace_extra_tags | Extra tags for Redis keyspace monitor | string | `` | no |
...
| latency_extra_tags | Extra tags for Redis latency monitor | string | `` | no |
...
| mem_frag_extra_tags | Extra tags for Redis memory RAM fragmentation monitor | string | `` | no |
...
| mem_used_extra_tags | Extra tags for Redis RAM memory used monitor | string | `` | no |
