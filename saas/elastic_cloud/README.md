# SAAS ELASTIC_CLOUD DataDog monitors

## How to use this module

```hcl
module "datadog-monitors-saas-elastic_cloud" {
  source      = "claranet/monitors/datadog//saas/elastic_cloud"
  version     = "{revision}"
...
| <a name="input_tags"></a> [tags](#input\_tags) | Global variables | `list(string)` | <pre>[<br>  "type:database",<br>  "provider:elastic_cloud",<br>  "resource:elasticsearch"<br>]</pre> | no |
